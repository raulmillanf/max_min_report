...
class MaxMinReport(models.Model):
    ...
    #@api.one
    #def compute_product_brand(self):
    #    self.product_brand_id = self.product_id.product_brand_id
    #product_brand_id = fields.Char(string="Marca", related=product_id.product_brand_id")
